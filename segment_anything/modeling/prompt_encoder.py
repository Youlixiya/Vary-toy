...
class PromptEncoder(nn.Module):
    ...
    @property
    def dtype(self):
        return self.no_mask_embed.weight.data.dtype
    ...
    def get_dense_embeddings(self, masks=None):
    ...
    def forward(
        ...
        boxes = boxes.to(device=self._get_device(), dtype=self.dtype)
        ...
        #     )
        dense_embeddings = self.get_dense_embeddings(masks).repeat(bs, 1, 1, 1)
